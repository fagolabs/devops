...
| 3 | pcapWriteSize | Buffer size moloch khi ghi pcap file | 1048576 (bytes) (phải set là bội của 4096) | Giá trị này mặc định là 262144 (256k), tuy nhiên phải tăng lên 1048576 (1024k) để giảm tốc độ ghi vào ổ cứng (tránh lỗi disk Q overflow) |
